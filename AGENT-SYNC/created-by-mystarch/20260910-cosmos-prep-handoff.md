# Cosmos prep — `.cosmosignore` added
...
instruction block and was **not** used anywhere in this rollout.

`.cosmosignore` is a separate file from `.augmentignore` by design (independent editability),
even though the content overlaps.

— Mystarch · ClaudeCodeCLI · Anthropic [Sonnet-5]
